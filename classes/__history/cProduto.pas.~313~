...
constructor TcProduto.Create(AId: Integer; ACodigo: Integer; ANome: string;
  APreco: Double; AQuantidade: Integer; AFoto: String);
begin
  inherited Create;
  FId := AId;
  FCodigo := ACodigo;
...
procedure TcProduto.saveEntityToDataBase(codigo: Integer; nome_produto: String;
  preco: Double; quantidade: Integer; foto: string);
begin
