...
type
  TuDataModule = class(TDataModule)
    ...
    qryVendaEfetuadaInsert: TADOQuery;
    dsCliente: TDataSource;
    qryClienteGetByCpf: TADOQuery;
    qryClienteSelectAll: TADOQuery;
    ...
    qryClienteGetByCpfid: TAutoIncField;
    qryClienteGetByCpfcpf: TStringField;
    qryClienteGetByCpfnome: TStringField;
  ...
  TOnCarrinhoChange = procedure(IsEmpty: Boolean) of object;
var
